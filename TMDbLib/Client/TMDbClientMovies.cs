...
namespace TMDbLib.Client
{
    public partial class TMDbClient
    {
        ...
        //talha
        public SearchContainer<MovieResult> GetMovieRecommended(int movieId, string language, int page = 0)
        {
            return GetMovieMethod<SearchContainer<MovieResult>>(movieId, MovieMethods.Recommendations, page: page, language: language, dateFormat: "yyyy-MM-dd");

        }
        //talha
        public SearchContainer<MovieResult> GetMovieRecommended(int movieId, int page = 0)
        {
            return GetMovieMethod<SearchContainer<MovieResult>>(movieId, MovieMethods.Recommendations, page: page, dateFormat: "yyyy-MM-dd");
        ...
        private T SearchMethod<T>(string method, int page, string language = null, bool? includeAdult = null, int year = 0, string dateFormat = null) where T : new()
        {
            RestRequest req = new RestRequest("movie/{method}");
        ...
        public SearchContainer<Movie> GetTopRatedMovie(int page,string language)
        {
            return SearchMethod<SearchContainer<Movie>>("top_rated", page, language);
        }
        public SearchContainer<Movie> GetPopularMovie(int page, string language)
        {
            return SearchMethod<SearchContainer<Movie>>("popular", page, language);
        }
